...
Built on the ``Tensor`` engine (stage_08, imported via stage_12). For a sequence X (T, d_model):
...
# Tensor (stage_08 via stage_12); softmax/cross_entropy_loss (stage_13, batched).
