...
This stage introduces no new math, so the testing has two halves:
  ...
  2. CORRECTNESS via central-difference gradient checking on Linear:
     ...
     compared against the analytic grad from Tensor.backward() (stage_08).
...
def test_parameter_is_grad_requiring_leaf_tensor():
    ...
    assert isinstance(p, Tensor), "Parameter must subclass the stage_08 Tensor"
...
# ===========================================================================
# MSELoss module wraps the stage_12 functional loss.
# ===========================================================================
