...
Reuses the stage_08 Tensor engine and stage_12 losses; penalties backprop
...
def _abs(t: "Stage8_Tensor") -> "Stage8_Tensor":
...
def l2_penalty(params: Iterable, lam: float = 1.0) -> "Stage8_Tensor":
...
def l1_penalty(params: Iterable, lam: float = 1.0) -> "Stage8_Tensor":
